...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const isLoading = common_vendor.computed(() => store.state.isLoading);
    ...
    const handleRecord = async () => {
      if (currentQuestion !== null && currentQuestion !== void 0) {
        if (isRecording.value) {
          isRecording.value = false;
          await utils_recorder.recorder.stop();
    ...
    return (_ctx, _cache) => {
      return common_vendor.e({
        ...
        h: common_vendor.t(currentIndex.value + 1 > questions.value.length ? currentIndex.value : currentIndex.value + 1),
        i: common_vendor.t(questions.value.length),
        j: common_vendor.t(currentQuestion.value)
      } : {}, {
        ...
        p: common_vendor.t(evaluation.value.score),
        q: common_vendor.t(evaluation.value.feedback)
      } : {});
    };
  }
};
