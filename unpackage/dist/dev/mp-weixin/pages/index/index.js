  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return common_vendor.e({
        ...
        b: currentQuestion.value
      }, currentQuestion.value ? {
        c: common_vendor.t(currentQuestion.value),
        d: common_vendor.t(currentIndex.value + 1),
        e: common_vendor.t(questions.value.length)
      } : {}, {
        f: common_vendor.t(isRecording.value ? `Recording... ${recordingTime.value}s` : "Start Recording"),
        g: isRecording.value ? 1 : "",
        h: common_vendor.o(handleRecord),
        i: evaluation.value
      }, evaluation.value ? {
        j: common_vendor.t(evaluation.value.score),
        k: common_vendor.t(evaluation.value.feedback)
      } : {});
    };
  }
};
